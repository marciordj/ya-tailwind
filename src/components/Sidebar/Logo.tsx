export function Logo() {
  return (
    <strong className='flex mx-1 items-center gap-2 text-lg font-semibold text-zinc-900'>
      <svg
        width={38}
        height={38}
        viewBox="0 0 38 38"
      ...
      >
        <g filter="url(#filter0_dd_20002_307)">
          <g clipPath="url(#clip0_20002_307)">
            ...
            <rect
              ...
              height={32}
              rx={8}
              fill="url(#paint0_linear_20002_307)"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            <path
              ...
              fill="#D0D5DD"
            />
            <g filter="url(#filter1_dd_20002_307)">
              <circle
                cx={19}
                cy={18}
                r={8}
                fill="url(#paint1_linear_20002_307)"
              />
            </g>
            <g filter="url(#filter2_b_20002_307)">
              <path
